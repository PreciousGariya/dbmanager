...
<head>
    ...
    <title>PreciousGariya | DbManager</title>
...
<body class="antialiased">
    ...
    <div class="container">
        <div class="px-4 py-5 my-5 text-center">
            ...
            <svg height="88px" width="88px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-51.2 -51.2 614.40 614.40" xml:space="preserve" fill="#bdbdbd" transform="matrix(-1, 0, 0, 1, 0, 0)rotate(0)" stroke="#bdbdbd" stroke-width="0.00512">

                <g id="SVGRepo_bgCarrier" stroke-width="0" transform="translate(0,0), scale(1)">

                    <rect x="-51.2" y="-51.2" width="614.40" height="614.40" rx="43.008" fill="#7ed0ec" strokewidth="0" />
            ...
            <h1 class="display-5 fw-bold">Welcome to Database Manager</h1>
            <div class="col-lg-6 mx-auto">
                <p class="lead mb-4"><strong>PreciousGariya\DbManager</strong> is a powerful and user-friendly Database Manager for Laravel, designed to simplify database management tasks for developers. Its comprehensive set of tools handles everything from creating and editing databases to querying and backing up data. With <strong>PreciousGariya\DbManager</strong>, you can securely manage your databases with just a few clicks, without having to worry about any technical details.</p>
                <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                    <a href="{{route('db-manager.step_1')}}" class="btn btn-primary btn-lg px-4 gap-3">Yes! I have</a>
